/* EXAMPLE_XOR/main.cpp - Application main entry point */
...
static const char * const TAG = "EXAMPLE_XOR";
...
extern "C" void app_main(void)
{
    ...
    ESP_LOGI(TAG, "Initializing EXAMPLE_XOR ...");
    ...
    */
    ...
    while (true) // Endlos-Schleife
    {
        ...
        // Ausgaenge setzen
        gpio_set_level(GPIO_Q1, I1 xor I2); //Verwendung des XOR aus der IEC IEC 61131; auch in C++ vorhanden, in C nicht not 
