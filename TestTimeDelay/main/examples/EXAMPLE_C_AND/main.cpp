/* EXAMPLE_C_AND/main.cpp - Application main entry point */
...
static const char * const TAG = "EXAMPLE_C_AND";
...
extern "C" void app_main(void)
{
    ...
    ESP_LOGI(TAG, "Initializing EXAMPLE_C_AND ...");
    ...
    */
    ...
    while (true) // Endlos-Schleife
    {
        ...
        // Ausgaenge setzen
        gpio_set_level(GPIO_Q1, I1 && I2); //Verwendung des C-UND "&&"
